-- =====================================================================
-- FOOTBALL AI PLATFORM — PRODUCTION SUPABASE POSTGRESQL DDL MIGRATION
-- Revisions: 001_stage4_core_schema -> 002_stage20_prediction_history -> 003_stage23_production_indexes
-- Description: Complete production schema DDL for empty Supabase PostgreSQL instance.
-- =====================================================================
...
-- ---------------------------------------------------------------------
-- REVISION 001: CORE RELATIONAL FOOTBALL SCHEMA
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- REVISION 002: STAGE 20 PREDICTION HISTORY SCHEMA
-- ---------------------------------------------------------------------

-- 21. Prediction Reports
CREATE TABLE IF NOT EXISTS prediction_reports (
    ...
    prediction_timestamp_utc TIMESTAMP WITHOUT TIME ZONE NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_prediction_reports_fixture_id ON prediction_reports(fixture_id);
CREATE INDEX IF NOT EXISTS idx_prediction_reports_decision_status ON prediction_reports(decision_status);

-- ---------------------------------------------------------------------
-- REVISION 003: STAGE 23 PRODUCTION PERFORMANCE HARDENING INDEXES
-- ---------------------------------------------------------------------

CREATE INDEX IF NOT EXISTS idx_matches_kickoff_status ON matches(scheduled_kickoff_utc, status);
CREATE INDEX IF NOT EXISTS idx_pred_reports_fixture_ts ON prediction_reports(fixture_id, prediction_timestamp_utc);
CREATE INDEX IF NOT EXISTS idx_pred_reports_status_ts ON prediction_reports(decision_status, created_at_utc);
...
INSERT INTO alembic_version (version_num) VALUES ('003_stage23_production_indexes')
