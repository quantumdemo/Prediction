...
* **WINDOW_1_2020_2021**:
  ...
  * 1X2 Log Loss: Empirical=1.08452 | Poisson=1.05171 | Dixon-Coles=1.05155 | LogisticReg=1.04627 | RandomForest=1.04673 | XGBoost=1.04138
* **WINDOW_2_2021_2022**:
  ...
  * 1X2 Log Loss: Empirical=1.07685 | Poisson=1.04141 | Dixon-Coles=1.04107 | LogisticReg=1.03799 | RandomForest=1.03959 | XGBoost=1.03288
* **WINDOW_3_2022_2023**:
  ...
  * 1X2 Log Loss: Empirical=1.07183 | Poisson=1.03800 | Dixon-Coles=1.03757 | LogisticReg=1.02961 | RandomForest=1.03029 | XGBoost=1.02455
* **WINDOW_4_2023_2024**:
  ...
  * 1X2 Log Loss: Empirical=1.07578 | Poisson=1.04402 | Dixon-Coles=1.04315 | LogisticReg=1.03165 | RandomForest=1.03382 | XGBoost=1.02844

AGGREGATED RESULTS:
Pooled evaluation across all 66,926 out-of-sample test matches:
* **XGBoost Forecaster** (`n=100, d=5, lr=0.05`): 1X2 Log Loss=1.03101 | Brier=0.61912 | RPS=0.21323 | Home Goal MAE=0.968 | Away Goal MAE=0.847 | Over 2.5 Brier=0.24668 | BTTS Brier=0.24854
* **Logistic Regression**: 1X2 Log Loss=1.03524 | Brier=0.62212 | RPS=0.21466 | Home Goal MAE=0.969 | Away Goal MAE=0.853 | Over 2.5 Brier=0.24722 | BTTS Brier=0.24890
* **Random Forest** (`n=100, d=8`): 1X2 Log Loss=1.03670 | Brier=0.62303 | RPS=0.21516 | Home Goal MAE=0.971 | Away Goal MAE=0.847 | Over 2.5 Brier=0.24722 | BTTS Brier=0.24880
...
5. `RandomForestForecaster` (Stage 11 non-linear ensemble forecaster, `n_estimators=100, max_depth=8`)
6. `XGBoostForecaster` (Stage 11 gradient boosted decision trees forecaster, `n_estimators=100, max_depth=5, learning_rate=0.05`)
...
TESTS:
- `services/ml/tests/test_stage12_backtesting.py`: 9 tests passed (including guard tests for metric reuse, leakage detection, window assignment, configuration alignment, and pooled aggregation).
- `services/ml/tests/`: All 42 ML test cases passed.
...
- `services/ml/app/backtesting/engine.py`
