...
class LogisticRegressionForecaster(BaseMLForecaster):
    ...
    def __init__(self, max_goals: int = 10):
        ...
        self.clf_1x2 = LogisticRegression(solver="lbfgs", max_iter=500, random_state=42)
        self.clf_btts = LogisticRegression(solver="lbfgs", max_iter=500, random_state=42)
        self.clf_over25 = LogisticRegression(solver="lbfgs", max_iter=500, random_state=42)
