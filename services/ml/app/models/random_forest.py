...
class RandomForestForecaster(BaseMLForecaster):
    ...
    def __init__(self, max_goals: int = 10, n_estimators: int = 100, max_depth: int = 8, n_jobs: int = -1):
        super().__init__(model_name="RandomForestForecaster", model_version="1.0.0")
        self.max_goals = max_goals
        self.clf_1x2 = RandomForestClassifier(n_estimators=n_estimators, max_depth=max_depth, random_state=42, n_jobs=n_jobs)
        self.clf_btts = RandomForestClassifier(n_estimators=n_estimators, max_depth=max_depth, random_state=42, n_jobs=n_jobs)
        self.clf_over25 = RandomForestClassifier(n_estimators=n_estimators, max_depth=max_depth, random_state=42, n_jobs=n_jobs)
        self.reg_home_goals = RandomForestRegressor(n_estimators=n_estimators, max_depth=max_depth, random_state=42, n_jobs=n_jobs)
        self.reg_away_goals = RandomForestRegressor(n_estimators=n_estimators, max_depth=max_depth, random_state=42, n_jobs=n_jobs)
